...
public class MessageConstant {
    ...
    public static final String DELETE_GROUP_FAIL= "删除权限失败";
    public static final String DELETE_GROUP_SUCCESS = "删除权限成功";
    ...
    public static final String EDIT_GROUP_FAIL = "编辑权限失败";
    public static final String EDIT_CHECKITEM_SUCCESS = "编辑检查项成功";
    public static final String EDIT_GROUP_SUCCESS = "编辑权限成功";
    ...
    public static final String QUERY_PERMISSION_ROLE_SUCCESS = "查询关联的角色成功";
    public static final String QUERY_PERMISSION_FAIL = "查询权限失败";
    public static final String QUERY_PERMISSION_ROLE_FAIL = "查询关联的角色失败";
    ...
    public static final String ADD_POWER_SUCCESS = "新增权限成功";
    public static final String ADD_POWER_FAIL = "权限名称已存在，请重新输入";
    public static final String DELE_POWER_FAIL = "删除权限失败，已关联角色";
    public static final String EDIT_SETMEAL_FAIL = "编辑套餐失败";
    public static final String EDIT_SETMEAL_SUCCESS = "编辑套餐成功";
    public static final String DELETE_SETMEAL_FAIL2 = "删除套餐失败";
    public static final String DELETE_SETMEAL_SUCCESS2 = "删除套餐成功";
    ...
    public static final String GET_MEMBER_AGE_REPORT_SUCCESS = "获取会员年龄报表成功";
    public static final String GET_MEMBER_AGE_REPORT_FAIL = "获取会员年龄报表失败";
    public static final String GET_MEMBER_SEX_REPORT_SUCCESS = "获取会员性别报表成功";
    public static final String GET_MEMBER_SEX_REPORT_FAIL = "获取会员性别报表失败";
    public static final String GET_MEMBER_NUMBER_REPORT_FAIL = "获取会员统计数据失败";
    public static final String LASTDATE_BEFORE_FIRSTDATE = "结束日期不能早于开始日期";
    ...
    public static final String QUERY_ROLE_LIST_SUCCESS = "获取角色列表成功";
    public static final String QUERY_PERMISSION_LIST_SUCCESS = "获取权限列表成功";
    public static final String QUERY_PERMISSION_LIST_FAIL = "获取权限列表失败";
    public static final String QUERY_ROLE_LIST_FAIL = "获取角色列表失败";
    public static final String GET_MENU_LIST_FAIL = "获取菜单列表数据失败";
    public static final String GET_MENU_LIST_SUCCESS = "获取菜单列表数据成功";
    public static final String UPDATE_PASSWORD_SUCCESS = "修改密码成功";
    public static final String UPDATE_PASSWORD_FAIL = "修改密码失败";
    public static final String PASSWORD_FAIL = "你输入的原始密码有误";
    public static final String AFFIRM_PASSWORD_FAIL = "两次输入的新密码不相同";
    public static final String NEWPASSWORD_OLDPASSWORD_FAIL = "原始密码和新密码相同，请重新输入";
    public static final String ADD_MENU_SUCCESS = "添加菜单成功";
    public static final String MENU_EXIST = "菜单编号或名称已存在，无法添加";
    public static final String MENU_EXIST_EDIT = "菜单编号或名称已存在，无法编辑";
    public static final String ADD_MENU_FAIL = "添加菜单失败";
    public static final String EXIST_CHILDREN = "该主菜单存在子菜单, 无法删除";
    public static final String DELETE_MENU_SUCCESS = "删除菜单成功";
    public static final String DELETE_MENU_FAIL = "删除菜单失败";
    public static final String EDIT_MENU_SUCCESS = "编辑主菜单成功";
    public static final String EDIT_MENU_FAIL = "编辑主菜单失败";
    public static final String PASSWORD_NULL_FAIL = "输入的密码不能为空";
    public static final String QUERY_USER_NAMES_FAIL = "获取全部用户名称数据失败";
    public static final String QUERY_USER_NAMES_SUCCESS = "获取全部用户名称数据成功";
    public static final String GET_ICON_SUCCESS = "获取图标成功";
    public static final String ADD_USER_SUCCESS = "添加用户成功";
    public static final String ADD_USER_FAIL = "添加角色失败";
